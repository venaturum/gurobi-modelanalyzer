...
.. py:function:: gurobi_modelanalyzer.kappa_explain(model, data=None, KappaExact=-1, prmfile=None, relobjtype="LP", expltype="ROWS", method="DEFAULT", smalltol=1e-13, submatrix=False, filename=None, env=None)
   ...
   :param env:        Optional Gurobi environment (gurobipy.Env) to use when constructing auxiliary
                          models.  Will override any environment set by :ref:`set_env <APIset_envLabel>`.
...
.. py:function:: gurobi_modelanalyzer.angle_explain(model, howmany=1, partol=1e-6, env=None)
...
.. py:function:: gurobi_modelanalyzer.set_env(env):
   ...
   :param env: An environment (gurobipy.Env) to use by default when constructing models.
